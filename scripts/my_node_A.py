...
from assignment_2_2023.msg import Vel , Feet
...
pub2 = rospy.Publisher("/feet_pos" , Feet , , queue_size = 1)
...
def publish_kinematics(msg):
	...
	# create a new position message in feet
	pos_feet = Feet()
	pos_feet.x = msg.pose.pose.position.x*3.28
	pos_feet.y = msg.pose.pose.position.y*3.28
	
	
	#Publish the custom message
	pub.publish(pos_vel)
	pub2.publish(pos_feet)
